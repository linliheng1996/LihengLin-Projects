      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)("danger", "Failed to log in.");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)("danger", "Error logging out.");
...
var signup = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(firstName, lastName, email, password, passwordConfirm) {
    var res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)("danger", "Failed to sign up.");
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)("danger", "Failed to send email.");
...
exports.updatePassword = exports.updateBasicInfo = void 0;
...
var updateBasicInfo = /*#__PURE__*/function () {
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              ...
              (0, _alert.showAlert)("success", "Basic info updated successfully!");
            }
          ...
          case 7:
            ...
            (0, _alert.showAlert)("danger", "Invalid Basic info.");
            console.log("error"); // console.log("error: " + err.response.data.message);
  ...
  return function updateBasicInfo(_x) {
    return _ref.apply(this, arguments);
  };
}();
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            _context2.t0 = _context2["catch"](0);
            // showAlert("danger", err.response.data.message);
            (0, _alert.showAlert)("danger", "Invalid password.");
            console.log("error"); // console.log("error: " + err.response.data.message);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            _context.t0 = _context["catch"](0);
            // showAlert("danger", err.response.data.message);
            (0, _alert.showAlert)("danger", "Invalid profile.");
            console.log("error"); // console.log("error: " + err.response.data.message);
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"appointment.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateAppointment = exports.deleteAppointment = exports.deleteBooking = exports.createAppointment = void 0;
...
var createAppointment = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(title, price, duration, description) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            res = _context.sent;
            if (res.data.status === "success") (0, _alert.showAlert)("success", "Appointment created successfully!");
            _context.next = 11;
            break;
          ...
          case 7:
            ...
            _context.t0 = _context["catch"](0);
            // showAlert("danger", err.response.data.message);
            (0, _alert.showAlert)("danger", "Invalid info.");
            console.log("error"); // console.log("error: " + err.response.data.message);
  ...
  return function createAppointment(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            _context2.t0 = _context2["catch"](0);
            // showAlert("danger", err.response.data.message);
            (0, _alert.showAlert)("danger", "Failed to delete booking.");
            console.log("error"); // console.log("error: " + err.response.data.message);
...
var deleteAppointment = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(appId) {
    var res;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "DELETE",
              url: "/api/v1/appointments/".concat(appId)
            });
          ...
          case 3:
            ...
            (0, _alert.showAlert)("success", "Appointment deleted successfully!"); // }
          ...
          case 8:
            ...
            _context3.t0 = _context3["catch"](0);
            // showAlert("danger", err.response.data.message);
            (0, _alert.showAlert)("danger", "Failed to delete appointment.");
            console.log("error"); // console.log("error: " + err.response.data.message);
  ...
  return function deleteAppointment(_x6) {
    return _ref3.apply(this, arguments);
  };
}();
...
var updateAppointment = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(appId, title, price, duration, description) {
    var res;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 4:
            ...
            (0, _alert.showAlert)("success", "Appointment updated successfully!"); // }
          ...
          case 10:
            _context4.prev = 10;
            _context4.t0 = _context4["catch"](0);
            (0, _alert.showAlert)("danger", "Failed to update appointment.");
            console.log("error");
  ...
  return function updateAppointment(_x7, _x8, _x9, _x10, _x11) {
    return _ref4.apply(this, arguments);
  };
}();
...
var createReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(review, rating, providerId) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "POST",
              url: "/api/v1/users/".concat(providerId, "/reviews"),
              data: {
                review: review,
                rating: rating
              }
          ...
          case 7:
            ...
            _context.t0 = _context["catch"](0);
            // showAlert("danger", err.response.data.message);
            (0, _alert.showAlert)("danger", "Invalid review. Please do not submit review more than once.");
            console.log("error"); // console.log("error: " + err.response.data.message);
...
var stripe = Stripe("pk_test_51HKX9SIpxP2Hbiv0RRra1XUKNJqT02CI46ymz77dQubNUQtOwmZrARoPRCNI6vmPhZe9QnPjNyLuQuBpq0u98Sk400iJO0Rfpq");
...
var updateBasicInfoForm = document.querySelector(".form-basic-info");
var updateProfileForm = document.querySelector(".form-profile");
var updatePasswordForm = document.querySelector(".form-pw-change");
var createAppointmentForm = document.querySelector(".form-create-appointment");
var updateAppointmentForm = document.querySelector(".form-update-appointment");
var createReviewForm = document.querySelector(".form-create-review");
var bookBtns = document.querySelectorAll("#book-appointment");
var deleteBookingBtns = document.querySelectorAll("#deleteBooking");
var deleteAppointmentBtns = document.querySelectorAll("#deleteAppointment");
var marketFilterSortForm = document.querySelector(".form-filter");
...
if (signupForm) signupForm.addEventListener("submit", function (e) {
  ...
  var email = document.getElementById("email").value;
  var password = document.getElementById("password").value;
  var passwordConfirm = document.getElementById("passwordConfirm").value; // console.log(passwordConfirm);

  (0, _account.signup)(firstName, lastName, email, password, passwordConfirm);
});
if (logoutButton) logoutButton.addEventListener("click", _account.logout);
if (forgotPasswordForm) forgotPasswordForm.addEventListener("submit", function (e) {
  e.preventDefault();
  var email = document.getElementById("email").value;
  (0, _account.forgotPassword)(email);
});
if (updateBasicInfoForm) updateBasicInfoForm.addEventListener("submit", function (e) {
  e.preventDefault();
  var form = new FormData(); // const email = document.getElementById("email").value;
  // console.log("email " + email);

  form.append("email", document.getElementById("email").value);
  var photo = document.getElementById("photo").files[0];
  if (photo) form.append("photo", document.getElementById("photo").files[0]);
  (0, _updateSettings.updateBasicInfo)(form);
});
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            document.querySelector(".btn-change-password").textContent = "Change Password";
...
if (updateProfileForm) updateProfileForm.addEventListener("submit", function (e) {
  ...
  form.append("majorCategory", document.getElementById("majorCategory").value);
  ...
  form.append("personalWebsite", document.getElementById("personalWebsite").value);
  form.append("description", document.getElementById("description").value);
  (0, _updateProfile.updateProfile)(form);
});
if (createAppointmentForm) createAppointmentForm.addEventListener("submit", /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
    var title, price, duration, description;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            (0, _appointment.createAppointment)(title, price, duration, description);
...
if (updateAppointmentForm) updateAppointmentForm.addEventListener("submit", /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
    var appId, title, price, duration, description;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            duration = document.getElementById("duration").value;
            description = document.getElementById("description").value;
            (0, _appointment.updateAppointment)(appId, title, price, duration, description);
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            (0, _review.createReview)(review, rating, providerId);
...
if (bookBtns) for (var i = bookBtns.length - 1; i >= 0; i--) {
  bookBtns[i].addEventListener("click", function (e) {
    e.target.textContent = "Processing...";
    var appId = e.target.dataset.appId; // console.log("appId" + appId);

    (0, _stripe.book)(appId);
  });
}
if (deleteBookingBtns) for (var i = deleteBookingBtns.length - 1; i >= 0; i--) {
  deleteBookingBtns[i].addEventListener("click", function (e) {
    var appId = e.target.dataset.appId; // console.log("appId" + appId);

    (0, _appointment.deleteBooking)(appId);
  });
}
if (deleteAppointmentBtns) for (var i = deleteAppointmentBtns.length - 1; i >= 0; i--) {
  deleteAppointmentBtns[i].addEventListener("click", function (e) {
    var appId = e.target.dataset.appId; // console.log("appId" + appId);

    (0, _appointment.deleteAppointment)(appId);
  });
}

if (marketFilterSortForm) {
  marketFilterSortForm.addEventListener("submit", /*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(e) {
      var sortBy, ratingFilter, majorCategory, yearOfStudy, queryUrl, cur;
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              ratingFilter = $("input[name=ratingFilter]:checked").val();
              majorCategory = document.getElementById("majorCategory").value;
              yearOfStudy = document.getElementById("yearOfStudy").value;
              if (ratingFilter == null) ratingFilter = 1;
              queryUrl = "";
              queryUrl += "sort=".concat(sortBy);
              queryUrl += "&ratingsAverage[gte]=".concat(ratingFilter);
              if (majorCategory !== "-") queryUrl += "&majorCategory=".concat(majorCategory);
              if (yearOfStudy !== "-") queryUrl += "&yearOfStudy=".concat(yearOfStudy);
